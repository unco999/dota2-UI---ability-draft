export class GameConfig {
    constructor() {
        ...
        GameRules.SetHeroSelectionTime(-1); // 选择英雄阶段的持续时间
        GameRules.SetShowcaseTime(-1); // 选完英雄的展示时间
        GameRules.SetPreGameTime(-1); // 进入游戏后号角吹响前的准备时间
        GameRules.SetStrategyTime(999999)
        ...
        GameRules.SetCustomGameTeamMaxPlayers(DotaTeam.CUSTOM_2, 2)
        GameRules.SetCustomGameTeamMaxPlayers(DotaTeam.CUSTOM_3, 2)
        GameRules.SetCustomGameTeamMaxPlayers(DotaTeam.CUSTOM_4, 2)
